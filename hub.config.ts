...
export const REGIONS: RegionConfig[] = [
  {
    ...
    metaDescription: 'Family-owned pest control for Nassau County since 1982. Serving Oceanside, Hempstead, Garden City & 132 Nassau communities. Targeted, EPA-registered treatments.',
    towns: NASSAU_TOWNS,
