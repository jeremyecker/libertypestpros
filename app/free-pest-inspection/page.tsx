...
export const metadata: Metadata = {
  title: 'Free Phone Assessment for Pest Control Nassau County, Long Island',
    ...
    <main className="min-h-screen">
      ...
      <section className="mb-10 mt-4 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Free Phone Assessment in Nassau County, Long Island</h2>
          <div className="prose prose-lg max-w-none">
            <p>Nassau County sits on sandy coastal soil where subterranean termites thrive, and aging homes develop foundation gaps that let Norway rats and house mice move indoors. Moisture from poor drainage softens wood and invites carpenter ants, and bed bugs arrive through travel and second-hand furniture. The free phone assessment gives you a clear picture of what you are dealing with and what it will cost before any money changes hands.</p>
            <p>The phone assessment is not a sales call. We ask what you have seen, where you have seen it, when the activity started, and what access we will need. You decide whether to book treatment. There is no obligation and no follow-up pressure. Commercial properties—restaurants, offices, multi-family buildings, healthcare facilities, schools, and food-processing sites—can book a free on-site assessment followed by a written proposal with price and scope.</p>
            <h3>What Happens on the Call</h3>
            <ul>
              <li><strong>Describe the Problem</strong> — Tell us what you have seen, where, and when the activity started.</li>
              <li><strong>We Ask Questions</strong> — We ask about your property, the pest activity, access for treatment, and any previous work.</li>
              <li><strong>You Get a Price</strong> — We give you a clear price on the call before any work is scheduled.</li>
              <li><strong>You Decide</strong> — Same-day service is available when you are ready to move forward.</li>
            </ul>
          </div>
        </div>
      </section>
