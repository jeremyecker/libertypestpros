...
const VERTICALS: Record<string, VerticalData> = {
  ...
  offices: {
    ...
    metaDesc: 'Office pest control Nassau County, NY. Disruption-free IPM for corporate offices & business parks. Liberty Pest Pros since 1982. Call (516) 763-4600.',
  ...
  retail: {
    ...
    metaDesc: 'Retail pest control Nassau County, NY. Protect merchandise & reputation in Nassau County stores. Liberty Pest Pros. Call (516) 763-4600.',
  ...
  healthcare: {
    ...
    metaDesc: 'Healthcare pest control Nassau County, NY. IPM programs for hospitals, clinics & medical offices. Regulation-compliant. Liberty Pest Pros. Call (516) 763-4600.',
  ...
  warehouses: {
    ...
    metaDesc: 'Warehouse pest control Nassau County, NY. Large-footprint IPM for warehouses & distribution centers. Liberty Pest Pros. Call (516) 763-4600.',
  ...
  hotels: {
    ...
    metaDesc: 'Hotel pest control Nassau County, NY. Reputation-protecting IPM for hotels & hospitality properties. Liberty Pest Pros. Call (516) 763-4600.',
...
const SHORT_TITLES: Record<string, string> = {
  restaurants: 'Restaurant Pest Control Nassau County',
  offices: 'Office Pest Control Nassau County',
  retail: 'Retail Pest Control Nassau County',
  healthcare: 'Healthcare Pest Control Nassau County',
  schools: 'School Pest Control Nassau County',
  warehouses: 'Warehouse Pest Control Nassau County',
  hotels: 'Hotel Pest Control Nassau County',
  'property-management': 'Property Management Pest Control Nassau',
  'food-processing': 'Food Processing Pest Control Nassau',
  daycare: 'Daycare Pest Control Nassau County',
};
...
export async function generateMetadata({ params }: { params: Promise<{ region: string; vertical: string }> }): Promise<Metadata> {
  ...
  if (!data) return {};
  const shortTitle = SHORT_TITLES[vertical] ?? `${data.title} Nassau County, NY`;
  return {
    title: { absolute: `${shortTitle} | Liberty Pest Pros` },
    description: data.metaDesc,
    openGraph: {
      title: `${shortTitle} | Liberty Pest Pros`,
      description: data.metaDesc,
