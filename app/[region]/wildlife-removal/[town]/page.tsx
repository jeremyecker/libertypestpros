...
const SERVICE_CONTENT: Record<string, ServiceContent> = {
  nassau: {
    ...
    body: `Nassau County's coastal marshes, golf courses, and mature residential neighborhoods support a diverse wildlife community — raccoons, deer, foxes, coyotes, Canada geese, opossums, skunks, and more. When wildlife intrudes into Nassau homes or creates public safety concerns, licensed professional intervention is the safe and legal solution. Our Nassau County wildlife removal team handles all nuisance wildlife under New York State DEC licenses, using species-appropriate exclusion and removal methods. From raccoon attic eviction in Garden City to Canada geese management on a Massapequa corporate campus, we provide full-spectrum wildlife control for residential, commercial, and municipal clients throughout Nassau County.`,
    faqs: [
      ...
      { q: 'Are opossums dangerous to Nassau County pets?', a: 'Opossums are generally non-aggressive and rarely carry rabies (their body temperature is too low for the virus to survive). However, they can hiss and bite if cornered and should not be handled by residents. Call us for humane removal.' },
    ],
  },
};
