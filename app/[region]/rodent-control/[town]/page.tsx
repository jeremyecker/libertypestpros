...
const SERVICE_CONTENT: Record<string, ServiceContent> = {
  nassau: {
    ...
    body: `Liberty Pest Pros controls rodent infestations throughout Nassau County with precision programs that address both the immediate problem and the structural vulnerabilities that allowed rodents in. Nassau County's older housing stock — much of it built in the 1940s–1970s — has accumulated decades of small gaps and cracks around utility penetrations, foundation walls, and attached garage thresholds that give mice and rats easy access. Liberty's Nassau County rodent program combines a systematic exclusion inspection (identifying every gap larger than 1/4 inch), interior trapping programs, and exterior perimeter bait station deployment for properties with ongoing rat pressure. We also advise on the sanitation and harborage conditions that make Nassau County properties attractive to rodents in the first place.`,
    faqs: [
      { q: `How do I stop mice from entering my Nassau County home every fall?`, a: `The permanent solution is exclusion — identifying and sealing every entry point before the fall migration window (September–October). Common gaps include dryer vent surrounds, gas line penetrations, cable conduit entry points, and garage door threshold gaps. Liberty offers fall exclusion inspections timed to Nassau County's peak mouse entry season.` },
      { q: `Are Norway rats present in Nassau County suburbs?`, a: `Yes, particularly in Nassau County communities adjacent to dense commercial areas, older residential neighborhoods in Hempstead and Freeport, and properties near tidal waterways. Norway rats are ground burrowers that typically enter structures through foundation cracks and slab penetrations. Liberty's exterior bait station program provides sustained control for rat-pressure properties.` },
      { q: `What is Liberty's rodent control guarantee for Nassau County?`, a: `Liberty Pest Pros backs all rodent control programs with a service guarantee — if you see new activity between scheduled visits, we return at no charge. Monthly service plan customers receive priority scheduling and quarterly exclusion inspections to catch new vulnerabilities before rodents exploit them.` },
    ],
  },
};
