...
const SERVICE_CONTENT: Record<string, ServiceContent> = {
  nassau: {
    ...
    faqs: [
      ...
      { q: 'What are the service terms for squirrel exclusion in Nassau County?', a: 'Every exclusion job includes a service agreement — the technician explains what is covered, including any follow-up visits, before work begins.' },
    ],
  },
};
