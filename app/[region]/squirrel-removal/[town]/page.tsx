...
const SERVICE_CONTENT: Record<string, ServiceContent> = {
  nassau: {
    ...
    body: `Liberty Pest Pros removes gray squirrels from Nassau County homes efficiently and humanely, using a one-way exclusion funnel method that allows squirrels to exit without being able to return — then permanently sealing all entry points with galvanized steel mesh that squirrels cannot gnaw through. Nassau County's squirrel population is dense across the county's tree-lined communities, and fall attic intrusions are a predictable annual event in neighborhoods like Roslyn Heights, Oyster Bay, Syosset, and Woodbury. Liberty's Nassau County squirrel service includes a full attic inspection to document damage, photography of all entry points and exclusion work, and a written post-service report for homeowners who wish to file insurance claims for squirrel damage.`,
    faqs: [
      { q: `Do squirrels in Nassau County attics cause fire hazards?`, a: `Yes. Squirrels chew continuously to keep their incisors from overgrowing, and wiring insulation is a preferred gnaw target. Exposed wires in an attic are a genuine fire risk. After squirrel removal, Liberty recommends having an electrician inspect attic wiring. We include photographic documentation of any chewed wiring observed during exclusion.` },
      { q: `What is the best time of year to remove squirrels from a Nassau County home?`, a: `The safest removal windows are late summer (August–September) between the spring and fall litters, and mid-winter (January–February) after the fall litter is weaned. Spring removal risks separating nursing kits from their mother, creating additional problems. Liberty assesses litter status before recommending a removal timeline.` },
      { q: `How does Liberty seal squirrel entry points at Nassau County homes?`, a: `Liberty uses 16-gauge galvanized steel hardware cloth (1/2-inch mesh) secured with stainless steel screws and construction-grade sealant. Soffit and fascia entry points are backed with steel mesh before the original material is reattached. All exclusion work is weather-sealed for Nassau County's coastal climate conditions.` },
    ],
  },
};
