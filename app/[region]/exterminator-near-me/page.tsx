...
export const metadata: Metadata = {
  title: { absolute: 'Exterminator Near Me Nassau County | Liberty Pest Pros' },
  description: 'Licensed Nassau County exterminators with same-day service available. Trusted, certified, guaranteed. Family-owned since 1982. Call (516) 763-4600.',

  openGraph: {
    title: 'Exterminator Near Me Nassau County | Liberty Pest Pros',
    description: 'Licensed Nassau County exterminators with same-day service available. Trusted, certified, guaranteed. Family-owned since 1982. Call (516) 763-4600.',
