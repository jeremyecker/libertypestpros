...
const SERVICE_CONFIG: Record<string, {
  ...
  'bed-bug-exterminator': {
    ...
    faqs: [
      { q: 'How do I know if I have bed bugs?', a: 'Look for small rust-colored stains on mattress seams, tiny dark spots (droppings), or itchy welts in a line or cluster on your skin after sleeping. A paid on-site bed bug inspection confirms the presence and extent of an infestation, with findings explained on the spot.' },
  ...
  'termite-control': {
    ...
    whatWeOffer: [
      { title: 'Termite Inspection', desc: 'Full structure inspection; paid WDO inspection report available for real estate transactions' },
      { title: 'Liquid Barrier Treatment', desc: 'Fipronil-based termiticide barrier application' },
      { title: 'Bait Systems', desc: 'Cellulose-based bait station monitoring & colony control' },
    ...
    faqs: [
      ...
      { q: 'What treatment do you use?', a: 'We use fipronil-based liquid barrier treatments and cellulose-based bait systems — two research-backed approaches. The right choice depends on your home\'s construction and the extent of activity.' },
