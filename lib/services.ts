...
export function getServiceDescription(service: Service, region: RegionConfig): string {
  ...
  const descriptions: Record<string, string> = {
    ...
    'bed-bug-removal': `Help your family sleep easy again. Thorough bed bug removal that's gentle on your home and safe for your family. Serving all of ${area}.`,
    ...
    'wasp-hornet-removal': `Protect your kids and pets from stinging insects. We'll remove wasp and hornet nests from your yard, porch, and eaves — fast and safe.`,
